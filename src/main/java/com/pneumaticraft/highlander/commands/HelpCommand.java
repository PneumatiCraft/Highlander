...
public class HelpCommand extends HighlanderCommand {
    private static final int CMDS_PER_PAGE = 7;

    public HelpCommand(Highlander plugin) {
        super(plugin);
        this.setName("Get Help with Highlander");
        this.setCommandUsage("/hi " + ChatColor.GOLD + "[FILTER] [PAGE #]");
        this.setArgRange(0, 2);
        this.addKey("hi");
        this.addKey("hih");
        this.addKey("hihelp");
        this.addKey("hi help");
        this.addKey("hisearch");
        this.addKey("hi search");
        this.setPermission("highlander.help", "Displays a nice help menu.", PermissionDefault.TRUE);
    }

    @Override
    public void runCommand(CommandSender sender, List<String> args) {
        sender.sendMessage(ChatColor.AQUA + "====[ Highlander Help ]====");
